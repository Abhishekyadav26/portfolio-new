...
function App() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      title: "Aia Stake",
      description:
        "Our cutting-edge staking and rewarding platform is built on the AIA blockchain, designed to provide users with secure, scalable, and efficient staking opportunities. The app allows users to stake their AIA tokens and other supported assets",
      icon: "🧠",
